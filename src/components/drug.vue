        ...
        <template v-for="(item, index) in users">
          <v-list-item :key="item.recordId">
            <template v-slot:default="{ active }">
              <v-list-item-content>
                <v-list-item-title v-text="item.drugId"></v-list-item-title>
                ...
                <v-list-item-subtitle v-text="item.drugname"></v-list-item-subtitle>
              </v-list-item-content>
...
import {actionsMixin, cookieValue} from '/home/omar/admin-tem/test/src/data/actions.js';
  ...
  export default {
   ...
   methods :{
      ...
      const res = await fetch('http://localhost:3000/api/org.lms.ehr.Drug',{headers});
